...
By implementing this with NAND gates we've got the circuit shown on
Figure \ref{3_3}.
...
\begin{figure}[h!]
\begin{centering}
\includegraphics[scale=0.2]{../Exercise3/images/e3}\includegraphics[scale=0.2]{../Exercise3/images/e4}
\par\end{centering}
