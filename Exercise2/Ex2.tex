...
-$Q$: Final result
    ...
    Connecting the circuit like the figure \ref{fig:ej2cir} being $X$ the second column and $Y$ the forth column, analysing the possible results would be:
	...
	Building the circuit in the figure \ref{fig:ej2cir}, with a squeare 0-5V signal, the measured results are:
